...
void Display_Init(void)
{
	...
	Parameter_Write(0x3A); // 0x27  //P4 -- Character Bytes per Row. D[7-0]=([C/R]x bpp)-1. Ahora está en C/R=40
	Parameter_Write(0x49); // P:29 G:0x49 //P5 -- Total Character Bytes per Row. D[7-0]=[C/R]+1. Ahora está en 73
	...
	Parameter_Write(0x28); // P:0x29 G:0x28 //P7 -- P8P7 habla de la cantidad de direcciones horizontales. El datasheet habla de 128 con el display de 512, pero considerando una pantalla virtual extra.Para nosotros(sin pantalla virtual) (320/8)=40=0x0028 (P8=0x00,P7=0x28).
